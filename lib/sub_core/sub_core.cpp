...
void sub_core_init() {
    ...
    analogWriteFrequency(pwmPin1, 10000); // Set to 5 kHz
    pinMode(DIRA_1, OUTPUT);
    pinMode(DIRB_1, OUTPUT);
    // Motor 2
    pinMode(pwmPin2, OUTPUT);
    analogWriteFrequency(pwmPin2, 10000); // Set to 5 kHz
    pinMode(DIRA_2, OUTPUT);
    pinMode(DIRB_2, OUTPUT);
    // Motor 3
    pinMode(pwmPin3, OUTPUT);
    analogWriteFrequency(pwmPin3, 10000); // Set to 5 kHz
    pinMode(DIRA_3, OUTPUT);
    pinMode(DIRB_3, OUTPUT);
    // Motor 4
    pinMode(pwmPin4, OUTPUT);
    analogWriteFrequency(pwmPin4, 10000); // Set to 5 kHz
